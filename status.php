...
<div class="main" style="padding-left: 0px;padding-right: 0px;background-color: #e3f2fd;">
	...
	<div class="cbox" style="width: 40%;">
		<form action="show.php" method="post">
			<label for="no_of_rooms" style="font-family: 'Asap', sans-serif;font-size: 1.2vw;text-align: left;">Enter your TID</label>
			<input type="number" name="tempid" placeholder="Enter the number of rooms you want" style="width: 100%;padding: 0.5rem;border-radius: 10px;" required>
			 <small id="emailHelp" class="form-text " style="color: white;">TID is an assigned to you at the time of booking</small>
	  		<button type="submit" name="submit1" class="btn" style="background-color: #e3f2fd;width: 100%;border-radius: 10px;">Check Status</button>
        </form>
	</div>
</div>
