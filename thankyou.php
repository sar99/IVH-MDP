...
<div class="main" style="padding-left: 0px;padding-right: 0px;background-color: #e3f2fd;">
	...
	<div class="cbox" style="width: 40%;">
		<h1 style="font-family: 'Acme', sans-serif;"> Your request for booking a room has been forwarded. Your TID is <?php echo $tempid; ?>.Kindly note it down for future referreneces.</h1>
	</div>
</div>
