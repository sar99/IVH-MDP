...
<ul class="nav nav-tabs" style="background-color: #e3f2fd;">
  ...
  <li class="nav-item col-lg-1.5">
    <a class="nav-link active" href="availability.php" style="color: #041D57;font-family: 'Acme', sans-serif;font-size: 1.5vw;border-top: 4px solid #041D57;">Check Availability</a>
  </li>
  <li class="nav-item col-lg-1.5">
...
<div class="main" style="padding-left: 0px;padding-right: 0px;background-color: #e3f2fd;">
	...
	<div class="cbox" style="width: 40%;">
		<h1 style="font-family: 'Acme', sans-serif;text-align: center;"> Rooms Available</h1>
      <ul class="list-group">
      ...
      $query="SELECT * FROM room WHERE occupany=0 AND roomid LIKE 'IVH%' AND roomtype=1";
      ...
      echo $num_rows; ?></span>
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center" style="color: black;">
         IVH - Non AC Rooms
          <span class="badge badge-primary badge-pill"><?php
      $query="SELECT * FROM room WHERE occupany=0 AND roomid LIKE 'IVH%' AND roomtype=0";
      $result=mysqli_query($conn,$query);
      $num_rows = mysqli_num_rows($result);
      echo $num_rows; ?></span>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center" style="color: black;">
          MDP - AC Rooms
          <span class="badge badge-primary badge-pill"><?php
      $query="SELECT * FROM room WHERE occupany=0 AND roomid LIKE 'MDP%' AND roomtype=1";
      $result=mysqli_query($conn,$query);
      $num_rows = mysqli_num_rows($result);
      echo $num_rows; ?></span>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center" style="color: black;">
          MDP - Non AC Rooms
          <span class="badge badge-primary badge-pill"><?php
      $query="SELECT * FROM room WHERE occupany=0 AND roomid LIKE 'MDP%' AND roomtype=0";
      $result=mysqli_query($conn,$query);
      $num_rows = mysqli_num_rows($result);
      echo $num_rows; ?></span>
        </li>
